...
const SPECIAL_ABILITIES: Dictionary = {
	...
	"chain_lightning": {
		...
		"rank_effects": [
			{"jumps": 2, "jump_damage_ratio": 0.35},
			{"jumps": 3, "jump_damage_ratio": 0.40},
			{"jumps": 4, "jump_damage_ratio": 0.45},
		],
	},
	"corrosion": {
	...
	"ricochet": {
		...
		"rank_effects": [
			{"extra_targets": 1, "ricochet_damage_ratio": 0.45},
			{"extra_targets": 2, "ricochet_damage_ratio": 0.48},
			{"extra_targets": 3, "ricochet_damage_ratio": 0.52},
		],
	},
	...
	"mine_round": {
		...
		"rank_effects": [
			{"impact_damage_ratio": 0.30, "arming_time": 0.70, "mine_ttl": 7.0, "trigger_damage_ratio": 1.20, "max_per_unit": 2, "team_cap": 24},
			{"impact_damage_ratio": 0.30, "arming_time": 0.55, "mine_ttl": 9.0, "trigger_damage_ratio": 1.45, "max_per_unit": 3, "team_cap": 24},
			{"impact_damage_ratio": 0.30, "arming_time": 0.40, "mine_ttl": 12.0, "trigger_damage_ratio": 1.75, "max_per_unit": 4, "team_cap": 24},
		],
	},
	"cluster_warhead": {
	...
	"shockwave_round": {
		...
		"rank_effects": [
			{"knockback": 60.0, "applies_slow": true, "normal_stun": 0.0},
			{"knockback": 85.0, "applies_slow": true, "normal_stun": 0.0},
			{"knockback": 110.0, "applies_slow": true, "normal_stun": 0.45},
		],
	},
	"shrapnel_storm": {
	...
	"stomp": {
		...
		"rank_effects": [
			{"radius": 105.0, "damage_ratio": 0.65, "applies_short_stun": true},
			{"radius": 125.0, "damage_ratio": 0.85, "applies_short_stun": true},
			{"radius": 145.0, "damage_ratio": 1.10, "applies_short_stun": true},
		],
	},
	"sweeping_slash": {
	...
	"suppression": {
		...
		"rank_effects": [
			{"hit_threshold": 6, "move_reduction": 0.20, "attack_speed_reduction": 0.10, "boss_reduced": true},
			{"hit_threshold": 5, "move_reduction": 0.25, "attack_speed_reduction": 0.15, "boss_reduced": true},
			{"hit_threshold": 4, "move_reduction": 0.30, "attack_speed_reduction": 0.20, "boss_reduced": true},
		],
	},
	"taunt_guard": {
	...
	"focus_mark": {
		...
		"rank_effects": [
			{"other_ally_damage_bonus": 0.05, "boss_multiplier": 0.50},
			{"other_ally_damage_bonus": 0.07, "boss_multiplier": 0.50},
			{"other_ally_damage_bonus": 0.10, "boss_multiplier": 0.50},
		],
	},
	"aerial_evade": {
	...
	"guardian": {
		...
		"rank_effects": [
			{"ttl": 14.0, "hp_ratio": 1.60, "attack_ratio": 0.45, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
			{"ttl": 18.0, "hp_ratio": 2.10, "attack_ratio": 0.55, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
			{"ttl": 22.0, "hp_ratio": 2.70, "attack_ratio": 0.65, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
		],
	},
	"auto_turret": {
		...
		"rank_effects": [
			{"ttl": 14.0, "shots_per_second": 2.0, "shot_damage_ratio": 0.25, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
			{"ttl": 18.0, "shots_per_second": 2.0, "shot_damage_ratio": 0.30, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
			{"ttl": 22.0, "shots_per_second": 2.0, "shot_damage_ratio": 0.35, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED},
		],
	},
	"repair_drone": {
		...
		"rank_effects": [
			{"duration": 5.0, "max_hp_heal_per_second": 0.025, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED, "target_roles": ["vehicle", "air"]},
			{"duration": 5.0, "max_hp_heal_per_second": 0.035, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED, "target_roles": ["vehicle", "air"]},
			{"duration": 5.0, "max_hp_heal_per_second": 0.045, "max_per_owner": 2, "team_summon_cap": SUMMON_TEAM_CAP, "recursive_summoning": SUMMON_RECURSIVE_ALLOWED, "target_roles": ["vehicle", "air"]},
		],
	},
	"self_repair": {
	...
	"last_stand": {
		...
		"rank_effects": [
			{"once_per_life": true, "survive_hp": 1.0, "invulnerability": 0.6, "grants_recovery": true},
			{"once_per_life": true, "survive_hp": 1.0, "invulnerability": 0.9, "grants_recovery": true},
			{"once_per_life": true, "survive_hp": 1.0, "invulnerability": 1.2, "grants_recovery": true},
		],
	},
	"lifesteal": {
		...
		"rank_effects": [
			{"lifesteal_ratio": 0.03, "cap_mode": "per_second"},
			{"lifesteal_ratio": 0.04, "cap_mode": "per_second"},
			{"lifesteal_ratio": 0.05, "cap_mode": "per_second"},
		],
	},
	"reactive_armor": {
...
static func validate_research(raw_research: Variant) -> PackedStringArray:
	...
	if not raw_research is Dictionary:
		...
		return errors
	if Dictionary(raw_research) != sanitize_research(raw_research):
...
static func snapshot_for_type(type_id: String, research: Variant) -> Dictionary:
	...
	for ability_value in SPECIAL_ABILITY_ORDER:
		...
		active_specials.append({
			...
			"effect": Dictionary(Array(ability["rank_effects"])[rank - 1]).duplicate(true),
		})
...
static func validate_catalog() -> PackedStringArray:
	...
	if SPECIAL_ABILITY_ORDER.size() != 47 or SPECIAL_ABILITIES.size() != 47:
		errors.append("catalog_requires_47_special_abilities")
